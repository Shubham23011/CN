...
with open("topo.json", "r") as json_file:
...
class EndDevice:
    ...
    def send_acc(self, name,):
        self.h.get_data("ack", name, [self.device_name, self.port_number])

    def get_data(self, msg, reciver_devices, devices):
    ...
    def send_data(self, msg, reciver_devices):
        self.h.get_data(msg, reciver_devices,
                        [self.device_name, self.port_number])
...
class Hub:
    ...
    def get_data(self, msg, reciver_devices, devices):
        for device in self.list_of_devices:
            device.get_data(msg, reciver_devices, devices)
...
def classdata(reciver_devices, sender_devices,message):
    ...
    end_device.send_data(message, reciver_devices)
...
def port_and_mac_assigen_to_devices(devices):
    ...
    for device_name in devices:
        ...
        device_info = {"device_name": device_name,
                       "port_number": port_number, "mac_number": mac_number}
